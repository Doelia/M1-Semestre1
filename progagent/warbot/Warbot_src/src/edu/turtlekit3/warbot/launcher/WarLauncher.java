...
public class WarLauncher extends TKLauncher {
	...
	/**
	 * Retourne une hashmap contenant les équipes (identifiés par leur nom). Chaque équipe est composée d'une liste d'agents.
	 * Chaque donnée de chaque agent est enregistré dans une hashmap
